...
12. Базовые основы вёрстки (*теория и практика без задач*)
13. [Функциональные выражения](#task13)
14. [Стрелочные функции и углубление в массивы](#task14)
...
Мы всегда можем обратиться к предыдущим версиям файлов в этом хранилище. GIT позволяет обмениваться историей разработки с другими разработчиками, храня при этом её как локально, так и на удалённом сервере.
...
## :small_orange_diamond: <a id="task14">Задание №14. Стрелочные функции и углубление в массивы.</a>

[К списку заданий](#navigation)

### Задачи

- Почитать о [стрелочных функциях](https://learn.javascript.ru/arrow-functions-basics/)
- Повторить [методы массивов](https://learn.javascript.ru/array-methods)
- Написать аналог метода `arr.filter()`. Функция должна принимать два аргумента:
...
Ссылка на код: https://github.com/Wladimix/slonit-homework/blob/main/task-14/app.js
