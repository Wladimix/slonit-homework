...
## <a id="task10">Задание №9. Повторяем объекты.</a>
...
- Задача со звездочкой - то же самое. Но вместо просто числа с суммой полей метод возвращает массив с названиями полей, причём эти названия полей отсортированы по убыванию.
